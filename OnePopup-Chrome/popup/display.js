// The code is the same as that of the Firefox version but since 
// Chrome uses callbacks instead of promises(Firefox), a polyfill has to be used
// and the namespace used in chrome is 'chrome'
// The polyfill is used to execute promises and the WebExtension API used in 
// Firefox to run smoothly in Chrome.
// Some API functions are missing but most of them work fine.
